...
import type { ApiResponse, ApiErrorResponse } from './useTasks.type';
...
export const useUpdateTask = () => {
  ...
  return useMutation({
    ...
    onMutate: async ({ id, data }) => {
      ...
      queryClient.setQueryData(taskKeys.detail(id), (old: ApiResponse<Task> | undefined) => ({
        ...old,
        data: { ...old?.data, ...data } as Task,
      }));
